...
_tabversion   = '3.10'
_lextokens    = set(('PLUSPLUS', 'LSHIFTEQUAL', 'OREQUAL', 'WSTRING_LITERAL', 'WCHAR_CONST', 'SIGNED', 'ELSE', 'LNOT', 'OFFSETOF', 'LOR', '_COMPLEX', 'FLOAT', 'INT_CONST_OCT', 'PPPRAGMA', 'CHAR_CONST', 'CONST', 'SHORT', 'NE', 'INT_CONST_BIN', 'XOREQUAL', 'IF', 'PLUS', 'INT_CONST_CHAR', '__INT128', '_BOOL', 'TIMES', 'EQUALS', 'WHILE', 'GT', 'DOUBLE', 'UNION', 'LE', 'PPPRAGMASTR', 'ELLIPSIS', 'XOR', 'AND', 'BREAK', 'ANDEQUAL', 'RETURN', 'LBRACKET', 'RSHIFT', 'DO', 'INT', 'DIVEQUAL', 'RESTRICT', 'RBRACKET', 'INLINE', 'RBRACE', 'MODEQUAL', 'REGISTER', 'TIMESEQUAL', 'LT', 'PLUSEQUAL', 'FLOAT_CONST', 'CASE', 'EQ', 'CHAR', 'FOR', 'STRUCT', 'COLON', 'EXTERN', 'DIVIDE', 'INT_CONST_DEC', 'COMMA', 'ENUM', 'MINUS', 'LAND', 'NOT', 'MINUSMINUS', 'MINUSEQUAL', 'STATIC', 'LONG', 'VOID', 'GOTO', 'LPAREN', 'SWITCH', 'PERIOD', 'CONDOP', 'STRING_LITERAL', 'DEFAULT', 'GE', 'RSHIFTEQUAL', 'VOLATILE', 'INT_CONST_HEX', 'CONTINUE', 'RPAREN', 'SIZEOF', 'LSHIFT', 'ARROW', 'PPHASH', 'SEMI', 'MOD', 'AUTO', 'OR', 'TYPEID', 'ID', 'UNSIGNED', 'TYPEDEF', 'LBRACE', 'HEX_FLOAT_CONST'))
_lexreflags   = 64
_lexliterals  = ''
