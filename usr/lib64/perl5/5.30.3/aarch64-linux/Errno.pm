...
"aarch64-linux-5.4.0-1037-aws" or
	die "Errno architecture (aarch64-linux-5.4.0-1037-aws) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
