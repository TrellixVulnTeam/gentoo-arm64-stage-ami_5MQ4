...
#define __GMP_CC "aarch64-ares-linux-gnu-gcc"
#define __GMP_CFLAGS "-O2 -pipe -fno-ident -fexcess-precision=fast -fomit-frame-pointer -mcpu=native --param l1-cache-size=64 --param l1-cache-line-size=64 --param l2-cache-size=1024"
